...
import { fetchBillingHistory, recordPayment as recordPaymentRequest } from "../services/billingAPI";
...
export default function BillingManagementPage() {
  ...
  const handleRecordPayment = async (payment) => {
    try {
      ...
      setSuccess(`Payment ${result.payment_slot ?? ""} for ${payment.consumerName} was saved to the database successfully.`);
      return true;
    } catch (requestError) {
      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <PaymentForm
          ...
          initialData={{
            ...
            amountPaid: record.outstandingBalance,
